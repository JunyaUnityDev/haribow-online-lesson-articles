...
1. **普段メイクと舞台メイクは「別物」だ、という新しい視点**
2. **顔が「光飛び」しないための、骨格でつくるベースメイクの考え方**
3. **子供（小学生〜高校生）にメイクを教える時の、押し付けない伝え方**

---

## 💭 プロローグ

7月、フリッキーが **MISAKI（ミサキ）** に弟子入りした記事が公開された。「メイクは『女性っぽくなる』ツールじゃない」という、男性入門者向けの講座。

あの記事を読んだ受講者の中で、もう一人、心がザワついた人がいた。

**シャイン。**

ダブルダッチプレイヤーであり、ファッションスタイリストでもある。自分のメイクはできる。でも——
...
ここから後半。シャインが直面しているもう一つの課題——**後輩の子供たちに、舞台メイクをどう教えるか**——に話が移る。
...
## ✨ エピローグ: ゴールは「技術完璧」じゃない

インタビューの最後、シャインが MISAKI にこう聞いた。
...
普段の自分は土台。その上に、今日のパフォーマンスのキャラを乗せる。
顔を飛ばさないために、骨格でベースを作る。
子供に教える時は、押し付けず、その子の「嫌」を拾い、少しずつ。

そして、何より。

**完璧じゃなくていい。続けることが、一番大切。**
...
{% include character.html name="misaki" position="left" text="MISAKI です。HARIBOW でスピード、メイク、衣装を担当しています。ダブルダッチ歴12年。今回はシャインの相談に乗りつつ、子供への教え方も伝えにきました" %}
...
{% include character.html name="shine" position="left" text="あたしシャイン!25歳、沖縄出身、ダブルダッチプレイヤー兼ファッションスタイリスト。今回はみさちゃんに弟子入りして、舞台メイクと子供への教え方を教わってきた〜!" %}

**シャイン**

- 25歳、沖縄出身
- ダブルダッチプレイヤー兼ファッションスタイリスト
- ダブルダッチ歴8年
- 太陽みたいな人だけど、影もちゃんとある
- 口癖:「ヤバくない?ヤバくない?」「うっそ、待ってマジ?」「センスの問題だよ、それ」
- 後輩の女子（小学生〜高校生）に、舞台メイクを教える立場になったばかり

---

## 📚 参考・関連情報

- [メイクは『女性っぽくなる』ツールじゃない — MISAKI のメンズ向け入門講座]({{ '/articles/makeup-intro-misaki/' | relative_url }})（同シリーズ、男性入門編・2026-07-15公開）
