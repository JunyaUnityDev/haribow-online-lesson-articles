...
{% include character.html name="flekky" position="left" text="オレ、フリッキー!19歳、ダブルダッチ歴1年8ヶ月の大学2年生っす。質問担当!" %}
...
{% include character.html name="top" position="right" text="フッ…俺がトップだ。52歳、関内のレコード屋やってる。歴史を語れる若者を一人でも多く残したい、それだけだ。" %}
...
<small>※ ヒップホップの起源には諸説あります。本記事は最も広く知られている説（1973年8月11日、ブロンクス・1520セジウィック・アベニューでのDJクール・ハークによる「Back to School Jam」）に基づいて構成しています。</small>
